...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputname" placeholder="部门名称" name="name" value="${data.name}">
...
<div class="col-sm-6">
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control required" id="inputleader_id" placeholder="部门领导" name="leader_id" value="${data.leader_id}">
